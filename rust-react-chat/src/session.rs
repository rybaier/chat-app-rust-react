...
// how long the connection is alive with the client
const HEARBEET: Duration = Duration::from_secs(5); 
// duration to check if client is still connected
const CLIENT_TIMEOUT: Duration = Duration::from_secs(10);
type DbPool = r2d2::Pool<ConnectionManager<PgConnection>>;

// structs to store data needed

// to make custom implementation of the Actix Web Actor
#[derive(Debug)]
...
//  determines chat type and connections
...
// Defines the object sent and recieved by user
